...
(function () {
    ...
    window.RsLiquideffectAddOn = function (_$, slider) {
        ...
        var effects = slider.find("li[data-liquideffect]").each(function () {
            ...
            if (sprite) {
                ...
                $this
                    .removeData("liquideffect")
                    .removeAttr("data-liquideffect");
            }
        });
    ...
    function LiquidCanvas(slide, w, h) {
        ...
        this.displacement = new PIXI.Sprite.fromImage(
            this.settings.image,
            true,
        );
        ...
        if (this.settings.interactive) {
            ...
            if (this.settings.event === "mousedown") {
                ...
                container.pointerup = container.pointerout =
    ...
    LiquidCanvas.prototype = {
        ...
        onMouseMove: function (e) {
            ...
            if (this.settings.interscalex || this.settings.interscaley) {
                ...
                if (this.settings.interscalex)
                    obj.x = this.settings.interscalex * v;
                if (this.settings.interscaley)
                    obj.y = this.settings.interscaley * v;
        ...
        transitionIn: function () {
            ...
            if (this.settings.transpower)
                obj2.onUpdate = this.onUpdateIn.bind(this);
        ...
        animateOut: function (nextslide) {
            ...
            if (this.settings.transpower)
                obj.onUpdate = this.onUpdateOut.bind(this);
