...
(function () {
    ...
    window.RsParticlesAddOn = function (f) {
        ...
        function m() {
            ...
            a.style.zIndex = parseInt(
                b.getAttribute("data-particles-index"),
                10,
            );
            e = setTimeout(g, 250);
        }
    ...
    var C = function (f, k, g, m, l) {
        ...
        a.fn.particle = function (b, c, d) {
            ...
            a.particles.move.random &&
                ((d = Math.round(Math.random() * (d - c) + c)),
                1 > d && (d = 1));
            this.spd = d;
            this.color = {};
                ...
                ? b.value instanceof Array
                    ? (this.color.rgb = t(
                          b.value[
                              Math.floor(
                                  Math.random() *
                                      a.particles.color.value.length,
                              )
                          ],
                      ))
                    : (void 0 != b.value.r &&
            ...
            switch (this.shape) {
                ...
                case "star":
                    a.fn.vendors.drawShape(
                        a.canvas.ctx,
                        this.x -
                            (2 * c) / (a.particles.shape.polygon.nb_sides / 4),
                        this.y - c / 1.52,
                ...
                case "image":
                    (a.canvas.ctx.globalAlpha = d),
                        (b =
                            "svg" == a.tmp.img_type
                                ? this.img.obj
                                : a.tmp.img_obj) && this.drawSVG(b, c),
        ...
        a.fn.particlesUpdate = function () {
            for (
                var b, c, d, h, f = a.particles.array.length, g = 0;
                g < f;
                g++
            ) {
                ...
                a.particles.size.anim.enable &&
                    (1 == e.size_status
                        ? (e.radius >= a.particles.size.value &&
                              (e.size_status = !1),
                          (e.radius += e.vs))
                ...
                (-1 < a.interactivity.events.onhover.mode.indexOf("bubble") ||
                    -1 <
                        a.interactivity.events.onclick.mode.indexOf(
                            "bubble",
                        )) &&
                    ...
                    for (b = a.particles.array.length, c = g + 1; c < b; c++)
                        (d = a.particles.array[c]),
                            ...
                            a.particles.move.bounce &&
                                a.fn.interact.bounceParticles(e, d);
            }
        };
        ...
        a.fn.modes.bubbleParticle = function (b) {
            if (
                    ...
                    ? 0 <= d &&
                      ...
                      (a.interactivity.modes.bubble.size != b.radius &&
                          (a.interactivity.modes.bubble.size > b.radius
                              ? ((c =
                                    b.radius +
                                    a.interactivity.modes.bubble.size * d),
                ...
                a.interactivity.events.onclick.enable &&
                    -1 <
                        a.interactivity.events.onclick.mode.indexOf("bubble") &&
                    (a.tmp.bubble_clicking &&
                        ...
                        (d =
                            (new Date().getTime() -
                                a.interactivity.mouse.click_time) /
                            1e3),
            ...
            if (
                ...
                a.interactivity.events.onclick.enable &&
                    ...
                    a.tmp.repulse_clicking
                        ? ((c = Math.pow(
                              a.interactivity.modes.repulse.distance / 6,
                              3,
                          )),
            ...
            if (
                ...
                c <= a.interactivity.modes.grab.distance &&
                    ((c =
                        ...
                        c /
                            (1 /
                                a.interactivity.modes.grab.line_linked
                                    .opacity) /
                            a.interactivity.modes.grab.distance),
                    0 < c &&
                        ((d = b.lineColor),
        ...
        a.fn.vendors.drawShape = function (a, c, d, f, g, k) {
            ...
            a.moveTo(0, 0);
            for (c = 0; c < b; c++)
                a.lineTo(f, 0), a.translate(f, 0), a.rotate(g);
            a.fill();
            a.restore();
        };
            ...
            "image" == a.particles.shape.type
                ? "svg" == a.tmp.img_type
                    ? a.tmp.count_svg >= a.particles.number.value
                        ? (a.fn.particlesDraw(),
                          a.particles.move.enable
                              ? (a.fn.drawAnimFrame = rspRequestAnimFrame(
                                    a.fn.vendors.draw,
                                ))
                              : rspCancelAnimFrame(a.fn.drawAnimFrame))
                        : a.tmp.img_error ||
