        ...
        opt.c.on("revolution.layeraction", function (event, obj) {
            ...
            if (obj_wb != undefined) {
                    ...
                    if (
                        ...
                        obj_wb.jitter_distance =
                            obj_wb.jitter_distance != undefined
                                ...
                                : parseInt(o.writehand.jittering.distance, 0) /
                                  100;
                        obj_wb.jitter_distance_horizontal =
                            obj_wb.jitter_distance_horizontal != undefined
                                ...
                                : parseInt(
                                      o.writehand.jittering.distance_horizontal,
                                      0,
                                  ) / 100;
                        obj_wb.jitter_offset =
                            obj_wb.jitter_offset != undefined
                                ? parseInt(obj_wb.jitter_offset, 0) / 100
                                : parseInt(o.writehand.jittering.offset, 0) /
                                  100;
                        obj_wb.jitter_offset_horizontal =
                            obj_wb.jitter_offset_horizontal != undefined
                                ? parseInt(obj_wb.jitter_offset_horizontal, 0) /
                                  100
                                : parseInt(
                                      o.writehand.jittering.offset_horizontal,
                                      0,
                                  ) / 100;
                        obj_wb.hand_type =
                            obj_wb.hand_type || o.writehand.handtype;
                    }
                    if (obj_wb.hand_function == "move") {
                        obj_wb.hand_type =
                            obj_wb.hand_type || o.movehand.handtype;
                    }
                ...
                if (hand.length > 0) {
                    ...
                    var wb = jQuery.extend(
                        true,
                        {},
                        obj.layersettings.whiteboard,
                    );
                }
        ...
        if (
            ...
            if (nextobj != undefined && nextobj.obj.length > 0) {
                var hi = hand.find(".wb-hand-inner"),
                    ...
                    wasinstaticlayer =
                        hand.closest(".tp-static-layers").length > 0
                            ? true
                            : false;
        ...
        switch (wb.hand_function) {
            ...
            case "draw":
                ...
                if (_d.splittext != undefined && _d.splittext != "none") {
                    wb.tweens = obj.layersettings.timeline.getChildren(
                        true,
                        true,
                        false,
                    );
                                ...
                                if (
                                    ...
                                    wb.rotatespeed =
                                        wb.hand_angle_repeat !== undefined
                                            ? parseFloat(speed) /
                                              parseFloat(wb.hand_angle_repeat)
                                            : speed > 1
                                              ? speed / 6
                                              : speed > 0.5
                                                ? speed / 6
            ...
            case "move":
                ...
                hand.data(
                    "outspeed",
                    obj.layersettings.frames[
                        obj.layersettings.frames.length - 1
                    ].speed / 1000,
                );
                hand.data(
                    "outease",
...
**************************************/
    var moveoutHand = function (opt, obj, wb) {
        var _d = obj.layer.data(),
            ...
            sp =
                _d.frames[obj.layersettings.frames.length - 1].speed / 1000 ||
                2,
