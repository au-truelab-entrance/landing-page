        ...
        onbeforeswap: function (data) {
            ...
            while (len--) {
                ...
                if (!data.contains(itm.el)) {
                    ...
                    itm.el.className =
                        itm.el.className + " hide-typewriter-cursor";
                }
            }
        },
        ...
        if (this.blinking) {
            ...
            css +=
                ...
                anime
                    ...
                    .replace(
                        "[speed]",
                        parseInt(this.blinkingSpeed, 10) * 0.001,
                    ) +
                "}" +
                "#" +
                el.id +
    ...
    TypewriterLayer.prototype = {
        ...
        start: function (delay, fromLoop) {
            ...
            if (!fromLoop) {
                ...
                this.revapi.trigger("revolution.slide.typewriterlooped", [
                    this.el,
                ]);
            }

            this.running = true;
            this.revapi.trigger("revolution.slide.typewriterstarted", [
                this.el,
            ]);
        ...
        animate: function () {
            ...
            if (next) {
                ...
                if (speed)
                    this.timer = setTimeout(this.animate.bind(this), speed);
                else this.animate();
            } else {
                this.running = false;
                if (this.hideCursor)
                    this.el.className =
                        this.el.className + " hide-typewriter-cursor";
                this.revapi.trigger("revolution.slide.typewriterended", [
                    this.el,
                ]);
            }
        },
