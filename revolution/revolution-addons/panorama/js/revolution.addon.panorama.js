...
(function () {
    ...
    window.RsAddonPanorama = function (_$, slider) {
        ...
        if (!_$ || !slider || typeof THREE === "undefined" || !requestFrame)
            return;
    ...
    PanoramaSlide.prototype = {
        ...
        render: function () {
            ...
            if (this.smoothZoom) {
                this.camera.fov +=
                    (this.fov * this.zoomVal - this.camera.fov) * 0.05;
        ...
        update: function (prop, val, callback) {
            ...
            switch (prop) {
                case "image":
                    ...
                    this.material.map = this.texture.load(
                        val,
                        this.onImgChange,
                    );
        ...
        mouseEvent: function (e) {
            ...
            if (e.type.search(/move|click/) !== -1) {
                ...
                if (!this.move) {
                    ...
                    this.x =
                        this.prevX +
                        (this.startX - (e.pageX - this.left)) * 0.1;

                    this.y =
                        this.prevY + (e.pageY - this.top - this.startY) * 0.1;
                }
        ...
        addEvents: function () {
            ...
            if (this.controls !== "none") {
                if (this.move) this.canvas.addClass("rsaddon-panorama-drag");
                    ...
                    this.slide.addClass("rsaddon-panorama-click");
            }
        },
