    ...
    (function (e) {
        ...
        function b(r, a) {
            ...
            xe && xe.removeClass("active"),
                (xe = e(o).addClass("active").appendTo(Ze).draggable(Er)),
        ...
        function k(e) {
            ...
            if (a)
                ...
                Qe.attr("data-opacity", t).val(t).removeAttr("disabled"),
                    Ye.val(e + "%").removeAttr("disabled"),
                    ce.find(".rev-cpicker-point-top").length > 2 &&
                        hr.addClass("active"),
                    ce.removeClass("open");
            }
            return [a, r];
        ...
        function m(e) {
            for (
                ...
                (r = (a = e[o]).align),
                    t.appendChild(h(r, a.position, f(a), u(a, r)));
                ...
                Cr
                    ? (Cr.hasClass("selected")
                          ? (r &&
                                or.data(
                                    "hex",
                                    Cr.attr("data-color").toLowerCase(),
                                ),
        ...
        function I(r) {
            ...
            "radial" === r.type && (a = "radial"),
                ...
                e(
                    '.rev-cpicker-orientation[data-direction="' + a + '"]',
                ).addClass("selected"),
                Q.val(C(a)),
                O(a),
                m(r.colors);
        ...
        function N(e, r, t) {
            ...
            re.hasClass("selected")
                ...
                : ((Ir.type = "linear"),
                  (Ir.angle = parseInt(Q.val(), 10).toString())),
                (Ir.colors = n),
        ...
        function M(e, r, a, t, i) {
            return Math.max(
                Math.min(
                    Math.round(Math.abs(((e - r) / (a - r)) * (i - t) + t)),
                    255,
                ),
                0,
            );
        ...
        function J() {
            ne || e.tpColorPicker(),
                ...
                ue.data(
                    "state",
                    nr.find(".rev-cpicker-color").eq(0).attr("data-color") ||
                        "#ffffff",
                ),
                le.data(
                    "state",
                    Ke.find(".rev-cpicker-color").eq(0).attr("data-color") ||
                        "linear-gradient(0deg, rgba(255, 255, 255, 1) 0%, rgba(0, 0, 0, 1) 100%)",
                ),
                mr.draggable({
                    containment: "window",
                ...
                Le.on("mousedown.revcpicker", function (e) {
                    ...
                    .on(
                        "mouseleave.revcpicker mouseup.revcpicker",
                        function () {
                            Pe = !1;
                        },
                    ),
                e(".rev-cpicker-main-btn").on("click.revcpicker", function () {
                    ...
                    if (
                        ...
                        De
                            ? (dr && (ir = fe.val()),
                              ce
                                  .removeClass("gradient-view")
                                  .addClass("color-view"))
                            : (dr && (ir = r),
                              ce
                                  .removeClass("color-view")
                                  .addClass("gradient-view"),
                              We ||
                                  we
                        ...
                        a
                            ? dr.css("background", t)
                            : (dr[0].style.background = t),
                            (kr = !0),
                            e(".rev-cpicker-color").not(".blank").each(l),
                            (kr = !1),
                            X.trigger("revcolorpickerupdate", [or, r]);
                    }
                }),
                e("#rev-cpicker-check").on("click.revcipicker", function () {
                    ...
                    (t = r[1] !== lr) &&
                        (or.attr("data-color", r[1]).val(a).change(),
                ...
                ce.on("click.revcpicker", function (r) {
                    if (ce.hasClass("open")) {
                        var a = r.target,
                            ...
                            o =
                                -1 !==
                                    a.className.search("rev-cpicker-point") ||
                        ...
                        o &&
                            ("text" === t.attr("type")
                                ? (o = !t.attr("disabled"))
                                : "rev-cpicker-check-gradient" === i &&
                                  (o = !1)),
                            o || x();
                    } else
                        Xe &&
                            !1 === /wheel|angle|reverse/.test(r.target.id) &&
                            (-1 === r.target.id.search("radial") &&
                                e(
                                    '.rev-cpicker-orientation[data-direction="' +
                                        parseInt(Q.val()) +
                                        '"]',
                ...
                xr.slider({
                    ...
                    slide: function (e, r) {
                        if (!yr) {
                            var a,
                                t = parseInt(
                                    100 * (r.value / Tr).toFixed(2),
                                    10,
                                );
                            fr &&
                                ((a = t ? "#ffffff" : "transparent"),
                                fe.val(a)),
                                0 === t && (a = "transparent"),
                                v(!1, a, t || "transparent"),
                                sr.val(t + "%");
                            ...
                            for (
                                isNaN(o) &&
                                    (o =
                                        "keyup" === c
                                            ? "0"
                                            : xe.attr("data-location")),
                                    r =
                                        (o = Math.max(
                                            0,
                                            Math.min(100, parseInt(o, 10)),
                                        )) < 50
                                            ? 1
                                            : -1;
                                -1 !== t.indexOf(o);
                                ...
                                o += r;
                            "focusout" === c &&
                                (i.val(o + "%"), xe.attr("data-location", o)),
                                xe.css("left", o + "%"),
                                N();
                        }
                    })
                ...
                e("body")
                    .on("click.revcpicker", ".rev-cpicker-point", function () {
                        Ze.find(".rev-cpicker-point.active").removeClass(
                            "active",
                        ),
                    ...
                    .on(
                        ...
                        function () {
                            if (Cr) {
                                if (Cr[0] === this && Cr.hasClass("selected"))
                                    return;
                                Cr.removeClass("selected");
                            }
                            ...
                            if (
                                (i.hasClass("active") &&
                                    i.find(".rev-cpicker-arrow-up").click(),
                                ...
                                (gr = !0),
                                    Ve.val(o).change(),
                                    "transparent" === fe.val() &&
                                        fe.val(o.toLowerCase()),
                                    (gr = !1);
                                var c = sr.val();
                                0 === parseInt(c, 10) && (o = "transparent"),
                                    v(!1, o, c);
                            } else
                                ae.removeClass("full"),
                                    Me.removeClass("full"),
                                    d(Cr.data("gradient"), !0),
                            ...
                            if (
                                ...
                                if (!t)
                                    return void console.log(
                                        "Preset does not have a name/title",
                                    );
                                var i = r.closest(
                ...
                e(".rev-cpicker-save-preset-btn").on(
                    "click.revcpicker",
                    function () {
                        if (oe) {
                            var r,
                ...
                e(".rev-cpicker-hex")
                    .on("focusout.revcpicker", function () {
                        ...
                        if ("rev-cpicker-color-hex" === this.id) {
                            if ((t = fe.val()))
                                if (
                                    ((t = RevColor.sanitizeHex(t)),
                                    RevColor.isColor.test(t))
                                )
                                    fe.val(t);
                                else {
                                    if (
                            ...
                            (t = pe.val() || RevColor.defaultValue),
                                (t = RevColor.sanitizeHex(t)),
                                RevColor.isColor.test(t) ||
                                    (t =
                                        (a = (r = e(this)).data(
                    ...
                    .on("focusin.revcpicker", $),
                e("#rev-cpciker-clear-gradient").on(
                    "click.revcpicker",
                    function () {
                ...
                e(".rev-cpicker-point-delete").on(
                    "click.revcpicker",
                    function () {
                        if (-1 !== this.className.search("active")) {
                            var e = xe.hasClass("rev-cpicker-point-bottom")
                                    ? "bottom"
                                    : "top",
                        ...
                        if (
                            (isNaN(o) &&
                                (o =
                                    "keyup" === c
                                        ? "0"
                                        : e(this).data("orig-value")),
                            (o = Math.max(0, Math.min(100, o))),
                            "focusout" === c &&
                                (i.val(o + "%"),
                                t || xe.attr("data-opacity", o)),
                            t)
                        )
                            v(!1, 0 === parseInt(o, 10) && "transparent", o),
                                G(o);
                        else {
                            var n = RevColor.rgbValues(
                                    xe.attr("data-color"),
                                    3,
                                ),
                                s = Ir.colors[Je];
                            (o = (0.01 * parseInt(o, 10))
                                .toFixed(2)
                                .replace(/\.?0*$/, "")),
                                (s.r = n[0]),
                                (s.g = n[1]),
                    ...
                    function (e) {
                        ...
                        for (
                            var r = parseInt(
                                    100 *
                                        (
                                            (e.pageX - ae.offset().left) /
                                            Nr
                                        ).toFixed(2),
                                    10,
                                ),
                                a =
                                    -1 !== this.id.search("bottom")
                                        ? "bottom"
                                        : "top",
                                t = "bottom" === a ? je : Fe,
                                i = r < 50 ? 1 : -1;
        ...
        var X,
            ...
            Or = {
                ...
                naming_error:
                    "Please enter a unique name for the new color preset",
            },
            Pr = [
                "#FFFFFF",
                "#000000",
        ...
        var Dr = {
            refresh: function () {
                ...
                if (r.hasClass("rev-cpicker-component")) {
                    ...
                    (t = i[0]),
                        (i =
                            "rgba" === i[1] && RevColor.transparentRgba(t, !0)
                                ? ""
                                : t),
                        "transparent" !== t
            ...
            return r && "string" == typeof r
                ...
                : this.each(function () {
                      ...
                      if (a.hasClass("rev-cpicker-component"))
                          a.tpColorPicker("refresh");
                      else {
                          var t,
                              i,
                              o = e(
                                  '<span class="rev-colorpicker"></span>',
                              ).data("revcolorinput", a),
                ...
                e("body").on(
                    ...
                    function () {
                        ...
                        var r,
                            ...
                            k,
                            u,
                            f = (or = e(this).data("revcolorinput")).attr(
                                "data-widget-id",
                            ),
                        ...
                        (r || t || a || o || i || c) &&
                            ...
                            (u =
                                or.val() ||
                                or.attr("data-color") ||
                                RevColor.defaultValue).split("||").length > 1 &&
                                ((u = RevColor.joinToRgba(u)), or.val(u)),
                            (g = d(u)),
                            (lr = g[0]),
                            (te = b || ge),
                            (oe = k || be),
