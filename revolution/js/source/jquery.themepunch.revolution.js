        ...
        setSize: function (opt) {
            ...
            if (opt.sliderLayout == "fullscreen" || opt.infullscreenmode) {
                ...
                if (opt.fullScreenOffsetContainer != undefined) {
                    try {
                        var offcontainers =
                            opt.fullScreenOffsetContainer.split(",");
                        if (offcontainers)
                            jQuery.each(
                                offcontainers,
                                function (index, searchedcont) {
                                    coh =
                                        jQuery(searchedcont).length > 0
                                            ? coh -
                                              jQuery(searchedcont).outerHeight(
                                                  true,
                                              )
                                            : coh;
                                },
            ...
            container
                ...
                .each(function (i) {
                    ...
                    if (_nc.hasClass("tp-caption")) {
                        ...
                        var pevents = "";
                        if (_nc.hasClass("tp-no-events"))
                            pevents = ";pointer-events:none";
                        _nc.wrap(
                            "<div " +
                                preid +
        ...
        if (
            ...
            if (
                ...
                punchgs.TweenLite.set(opt.ul, {
                    left: rl,
                    width:
                        opt.c.width() - _R.getHorizontalOffset(opt.c, "both"),
                });
        }
