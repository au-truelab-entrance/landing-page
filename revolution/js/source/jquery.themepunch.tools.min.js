        ...
        function (TweenPlugin, TweenLite) {
            ...
            var _numExp = /(?:\-|\.|\b)(\d|\.|e\-)+/g,
                ...
                _supportsOpacity = (function () {
                    ...
                    _isSafariLT6 =
                        _isSafari &&
                        Number(
                            _agent.substr(_agent.indexOf("Version/") + 8, 1),
                        ) < 6;
            ...
            var _transformProps =
                ...
                _forceSVGTransformAttr = (function () {
                    ...
                    var force =
                            _ieVers ||
                            (/Android/i.test(_agent) && !window.chrome),
                        svg,
                        rect,
                        width;
                ...
                _getMatrix = function (e, force2D) {
                    ...
                    if (
                        isDefault &&
                        _transformProp &&
                        ((none = _getComputedStyle(e).display === "none") ||
                            !e.parentNode)
                    ) {
                        if (none) {
                ...
                _getTransform = (_internals.getTransform = function (
                    ...
                    if (m !== _identity2DMatrix) {
                        if (m.length === 16) {
                            ...
                            tm.scaleX =
                                ((Math.sqrt(a11 * a11 + a21 * a21) * rnd +
                                    0.5) |
                                    0) /
                                rnd;
                            tm.scaleY =
                                ((Math.sqrt(a22 * a22 + a23 * a23) * rnd +
                                    0.5) |
                                    0) /
                                rnd;
                            tm.scaleZ =
                                ((Math.sqrt(a32 * a32 + a33 * a33) * rnd +
                                    0.5) |
                                    0) /
                                rnd;
                ...
                "transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin",
                {
                    parser: function (
                        ...
                        if (
                            ...
                            m2.skewX = _parseAngle(
                                v.skewX,
                                m1.skewX - m1.skewY,
                            ); //see notes below about skewY and why we subtract it from skewX here
            ...
            _registerComplexSpecialProp("backgroundSize", {
                ...
                formatter: function (v) {
                    ...
                    return _parsePosition(
                        v.indexOf(" ") === -1 ? v + " " + v : v,
                    ); //if set to something like "100% 100%", Safari typically reports the computed style as just "100%" (no 2nd value), but we should ensure that there are two values, so copy the first one. Otherwise, it'd be interpreted as "100% 0" (wrong).
                },
            });
            ...
            if (absolute) {
                if (origHeight > element.clientHeight) {
                    ...
                    if (element.clientHeight < origHeight) {
                        ...
                        element.style.height =
                            origHeight + borderTopAndBottom + "px";
                    }
                }
                if (origWidth > element.clientWidth) {
                    ...
                    if (element.clientWidth < origWidth) {
                        //IE8 and earlier use a different box model - we must include padding and borders
                        element.style.width =
                            origWidth + borderLeftAndRight + "px";
                    }
                }
            }
