...
(function ($) {
            ...
            if (!d.frames_added) {
                ...
                if (d.frames !== undefined) {
                    for (var i = 0; i < d.frames.length; i++) {
                        ...
                        if (d.frames[0].from === undefined)
                            d.frames[0].from = "o:inherit";
            ...
            if (!preset)
                if (startSlideAnimAt !== undefined) {
                    ...
                    if (opt.timelines.staticlayers)
                        jQuery.each(
                            opt.timelines.staticlayers.layers,
                            function (key, o) {
                                var _ = o.layer.data(),
                                    in_v_range =
                                        _actli >= o.firstslide &&
                                    ...
                                    in_uv_range =
                                        _actli < o.firstslide ||
                                        _actli > o.lastslide,
                                    flt = o.timeline.getLabelTime(
                                        "slide_" + o.firstslide,
                                    ),
                                    elt = o.timeline.getLabelTime(
                                        "slide_" + o.lastslide,
                                    ),
                                    ...
                                    isvisible =
                                        _.animdirection === "in"
                                            ...
                                            : _.animdirection === "out"
                                              ...
                                              : undefined,
                                    triggered_in =
                                        _.frames[0].delay === "bytrigger",
                                    triggered_out =
                                        _.frames[_.frames.length - 1].delay ===
                                        "bytrigger",
                                    layer_start_status =
                                        _.triggered_startstatus,
	...
	********************************************/
        prepareSingleCaption: function (obj) {
            ...
            _._pw =
                _._pw === undefined ? _nc.closest(".tp-parallax-wrap") : _._pw;
            ...
            _._slideid =
                _._slideid ||
                _nc.closest(".tp-revslider-slidesli").data("index");
            _._id =
                _._id === undefined ? _nc.data("id") || _nc.attr("id") : _._id;
            _._slidelink =
            ...
            if (
                _._togglelisteners === undefined &&
                _nc.find(".rs-toggled-content")
            ) {
            ...
            if (
                ...
                obj.offsety =
                    opt.conh / 2 -
                    (opt.gridheight[opt.curWinRange] * opt.bh) / 2;
            ...
            if (
                ...
                _.cssobj =
                    _.cssobj === undefined ? getcssParams(_nc, 0) : _.cssobj;
                ...
                if (!_nc.hasClass("fullscreenvideo") && !yvcover) {
                    punchgs.TweenLite.set(_nc, {
                        paddingTop:
                            Math.round(ncobj.paddingTop * opt.bh) + "px",
                        paddingBottom:
                            Math.round(ncobj.paddingBottom * opt.bh) + "px",
                        paddingLeft:
                            Math.round(ncobj.paddingLeft * opt.bw) + "px",
                        paddingRight:
                            Math.round(ncobj.paddingRight * opt.bw) + "px",
                        ...
                        borderTopWidth:
                            Math.round(ncobj.borderTopWidth * opt.bh) + "px",
                        borderBottomWidth:
                            Math.round(ncobj.borderBottomWidth * opt.bh) + "px",
                        borderLeftWidth:
                            Math.round(ncobj.borderLeftWidth * opt.bw) + "px",
                        borderRightWidth:
        ...
        createTimelineStructure: function (opt) {
            ...
            function addTimeLineWithLabel(layer, opt, parentobject, slideid) {
                ...
                if (slideid === "staticlayers") {
                    parentobject[layer.attr("id")].firstslide =
                        layer.data("startslide");
                    parentobject[layer.attr("id")].lastslide =
                        layer.data("endslide");
                }

                layer.data("slideid", slideid);
                parentobject[layer.attr("id")].defclasses = c =
                    layer[0].className;
                    ...
                    c.indexOf("rev_row") >= 0
                        ...
                        : c.indexOf("rev_column_inner") >= 0
                          ...
                          : c.indexOf("rev_group") >= 0
                            ? layer[0].getElementsByClassName(
                                  "rev_layer_in_group",
                              )
                            : "none";
	...
	***************************************/
        buildFullTimeLine: function (obj) {
            ...
            if (_.hoverframeindex !== -1 && _.hoverframeindex !== undefined) {
                if (!_nc.hasClass("rs-hover-ready")) {
                    ...
                    _.hoveranim = getAnimDatas(
                        $hover,
                        _.frames[_.hoverframeindex].to,
                    );
            ...
            for (
                ...
                if (frame_index !== _.hoverframeindex) {
                    ...
                    if (
                        _nc_tl_obj.firstslide !== undefined &&
                        frame_name === "frame_0"
                    ) {
                        ...
                        _nc_timeline.addPause(
                            "slide_" + _nc_tl_obj.firstslide + "_pause",
                        );
                        _nc_timeline.addLabel(
                            "slide_" + _nc_tl_obj.firstslide,
                            "+=0.005",
                        );
                    }
        ...
        createFrameOnTimeline: function (obj) {
            ...
            if (_.splittext && frame_index === 0) {
                ...
                var splittarget =
                    _nc.find("a").length > 0 ? _nc.find("a") : _nc;
                    ...
                    if ($splitnow && ri !== undefined) {
                        ...
                        for (var si in animobject) {
                            ...
                            if (_.frames[frame_index].bgcolor !== undefined) {
                                $fanim.backgroundColor =
                                    _.frames[frame_index].bgcolor;
                ...
                if (_._sfx_out === "block" && frame_index === _.outframeindex) {
                    ...
                    timeline.add(
                        tweens.content.staggerTo(
                            animobject,
                            $to.speed / 1000 / 2 - 0.001,
                            { x: 0, delay: $sfx_blockdelay },
                        ),
                        label + "+=0.001",
                    );
                    ...
                    for (var si in animobject) {
                        ...
                        for (var k in cycles.to) {
                            $tanim[k] = parseInt(
                                cycles.to[k].values[cycles.to[k].index],
                                0,
                            );
                            cycles.to[k].index =
            ...
            if (
                ...
                $mask_to.anim.ease =
                    $mask_to.anim.ease === undefined ||
                    $mask_to.anim.ease === "inherit"
                        ? _.frames[0].ease
                        : $mask_to.anim.ease;
            ...
            if (
                ...
                timeline.add(
                    tweens.mask.set(_._mw, { overflow: "visible" }),
                    label,
                );
            ...
            if (allcaptions)
                jQuery.each(allcaptions, function (i) {
                    ...
                    if (
                        ...
                        if (_R.removeMediaFromList)
                            _R.removeMediaFromList(_nc, opt);
...
**********************************************************************************************/
    ...
    var getTLInfos = function (obj) {
        ...
        obj.firstframe =
            obj.firstframe === undefined ? "frame_0" : obj.firstframe;
        obj.lastframe =
            obj.lastframe === undefined ? "frame_999" : obj.lastframe;
    ...
    var newAnimObject = function (a) {
        ...
        a.anim.rotationX =
            a.anim.rotationX === undefined ? 0 : a.anim.rotationX;
        a.anim.rotationY =
            a.anim.rotationY === undefined ? 0 : a.anim.rotationY;
        a.anim.rotationZ =
            a.anim.rotationZ === undefined ? 0 : a.anim.rotationZ;
        ...
        a.anim.transformOrigin =
            a.anim.transformOrigin === undefined
                ? "50% 50%"
                : a.anim.transformOrigin;
        ...
        a.anim.autoAlpha =
            a.anim.autoAlpha === undefined ? 1 : a.anim.autoAlpha;
        a.anim.visibility =
    ...
    var animDataTranslator = function (val, defval, $split, $splitamount, ext) {
        ...
        if (jQuery.isNumeric(parseFloat(val))) {
            ...
            if ($split !== undefined && $splitamount !== undefined) {
                val ==
                    "[" +
                        (parseInt(Math.random() * (max - min), 0) +
                            parseInt(min, 0)) +
                        "ext";
        ...
        if (customarray)
            jQuery.each(customarray, function (index, pa) {
                ...
                if (v != undefined) {
                    ...
                    o.anim.opacity =
                        o.anim.opacity == 0 ? 0.0001 : o.anim.opacity;
    ...
    var getcssParams = function (nc, level) {
        ...
        if (
            jQuery.inArray(nc.data("layertype"), [
                "video",
                "image",
                "audio",
            ]) === -1 &&
    ...
    var calcCaptionResponsive = function (nc, opt, level, responsive) {
        ...
        if (!nc.hasClass("tp-splitted")) {
            ...
            punchgs.TweenLite.set(nc, {
                ...
                borderBottomWidth:
                    Math.round(obj.borderBottomWidth * bh) + "px",
            ...
            if (_._nctype === "column") {
                if (_._column_bg_set === undefined) {
                    ...
                    _._column_bg_opacity =
                        _._column_bg_opacity === undefined
                            ? 1
                            : _._column_bg_opacity;
                ...
                if (_._cbgc_auto && _._cbgc_auto.length > 0) {
                    _._cbgc_auto[0].style.backgroundSize =
                        _._column_bg_image_size;
                    if (jQuery.isArray(obj.marginLeft)) {
                        punchgs.TweenLite.set(_._cbgc_auto, {
                            borderTopWidth:
                                obj.marginTop[opt.curWinRange] * bh + "px",
                            borderLeftWidth:
                                obj.marginLeft[opt.curWinRange] * bw + "px",
                            borderRightWidth:
                                obj.marginRight[opt.curWinRange] * bw + "px",
                            borderBottomWidth:
                                obj.marginBottom[opt.curWinRange] * bh + "px",
    ...
    var callCaptionLoops = function (el, factor) {
        ...
        if (el.hasClass("rs-pendulum")) {
            if (_._loop_timeline == undefined) {
                ...
                var startdeg =
                        el.data("startdeg") == undefined
                            ? -20
                            : el.data("startdeg"),
                    enddeg =
                        el.data("enddeg") == undefined ? 20 : el.data("enddeg"),
                    speed =
                        el.data("speed") == undefined ? 2 : el.data("speed"),
                    origin =
                        el.data("origin") == undefined
                            ? "50% 50%"
                            : el.data("origin"),
                    easing =
        ...
        if (el.hasClass("rs-pulse")) {
            if (_._loop_timeline == undefined) {
                _._loop_timeline = new punchgs.TimelineLite();
                var zoomstart =
                        el.data("zoomstart") == undefined
                            ? 0
                            : el.data("zoomstart"),
                    zoomend =
                        el.data("zoomend") == undefined
                            ? 0
                            : el.data("zoomend"),
                    speed =
                        el.data("speed") == undefined ? 2 : el.data("speed"),
        ...
        if (el.hasClass("rs-wave")) {
            if (_._loop_timeline == undefined) {
                ...
                var angle =
                        el.data("angle") == undefined
                            ? 10
                            : parseInt(el.data("angle"), 0),
                    radius =
                        el.data("radius") == undefined
                            ? 10
                            : parseInt(el.data("radius"), 0),
                    speed =
                        el.data("speed") == undefined ? -20 : el.data("speed"),
                    origin =
                        el.data("origin") == undefined
                            ? "50% 50%"
                            : el.data("origin"),
