        ...
        if (as)
            jQuery.each(as, function (i, a) {
                ...
                if (!opt.fullscreen_esclistener) {
                    if (
                        a.action == "exitfullscreen" ||
                        a.action == "togglefullscreen"
                    ) {
                ...
                switch (a.action) {
                    ...
                    case "toggle_mute_video":
                        jQuery.each(tnc, function (i, _tnc) {
                            _tnc = jQuery(_tnc);
                            var videomutetoggledby =
                                _tnc.data("videomutetoggledby");
                ...
                _nc.on(a.event, function () {
                    if (
                        a.event === "click" &&
                        _nc.hasClass("tp-temporarydisabled")
                    )
                        return false;
                    var tnc =
                        a.layer == "backgroundvideo"
