...
(function ($) {
    ...
    jQuery.extend(true, _R, {
        checkForParallax: function (container, opt) {
            ...
            function setDDDInContainer(li) {
                if (_.type == "3D" || _.type == "3d") {
                    ...
                    if (opt.sliderType == "carousel") {
                        if (_.ddd_shadow == "on")
                            dddw.addClass("dddwrappershadow");
                ...
                container.on(
                    ...
                    function (event, data) {
                        var currslide =
                            data && data.li
                                ? data.li
                                : container.find(".active-revslide");
                                ...
                                var t = jQuery(this),
                                    ...
                                    offrv =
                                        opt.conw == 0
                                            ? 0
                                            : Math.round(
                                                  (diffh / opt.conw) * pl * 100,
                                              ) || 0,
                                    offrh =
                                        opt.conh == 0
                                            ? 0
                                            : Math.round(
                                                  (diffv / opt.conh) * pl * 100,
                                              ) || 0,
                                    li = t.closest("li"),
                                    zz = 0,
                                    itslayer = false;
                                ...
                                var t = jQuery(this),
                                    ...
                                    offrv =
                                        opt.conw == 0
                                            ? 0
                                            : Math.round(
                                                  (diffh / opt.conw) * pl * 500,
                                              ) || 0,
                                    offrh =
                                        opt.conh == 0
                                            ? 0
                                            : Math.round(
                                                  (diffv / opt.conh) * pl * 700,
                                              ) || 0,
                                    li = t.closest("li"),
                                    zz = 0,
                                    itslayer = false;
            ...
            if (_s.layers !== undefined && _s.layers.length === 0)
                _s.layers = false;
        ...
        scrollHandling: function (opt, fromMouse, speedoverwrite) {
            ...
            if (
                ...
                return false;
            punchgs.TweenLite.delayedCall(0.2, saveLastScroll, [
                opt,
                window.scrollY,
            ]);
            ...
            if (_s.on && (_s.disable_on_mobile !== "on" || !_ISM)) {
                ...
                if (_s.layers !== false) {
                    ...
                    fadelevel =
                        fadelevel > 1 ? 1 : fadelevel < 0 ? 0 : fadelevel;
