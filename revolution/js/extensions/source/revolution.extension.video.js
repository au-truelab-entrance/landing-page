...
(function ($) {
    ...
    jQuery.extend(true, _R, {
            ...
            li.find(".tp-audiolayer").each(function () {
                ...
                if (element.find("audio").length === 0) {
                    ...
                    if (element.attr("id") === undefined)
                        element.attr(
                            "audio-layer-" + Math.round(Math.random() * 199999),
                        );
                    obj.id = element.attr("id");
                    obj.status = "prepared";
                    obj.start = jQuery.now();
                    obj.waittime =
                        element.data("videopreloadwait") * 1000 || 5000;
                        ...
                        if (_nc.hasClass("rs-apiready")) {
                            ...
                            if (!f.getPaused()) {
                                ...
                                setTimeout(function () {
                                    ...
                                    if (
                                        _nc.data("nextslideatend-triggered") ==
                                        1
                                    ) {
                                        ct = -1;
                                        _nc.data("nextslideatend-triggered", 0);
        ...
        checkVideoApis: function (_nc, opt, addedApis) {
            ...
            if (
                ...
                s.src =
                    "https://www.youtube.com/iframe_api"; /* Load Player API*/
            ...
            if (
                ...
                var f = document.createElement("script"),
                    ...
                    loadit = true;
                f.src =
                    "https://player.vimeo.com/api/player.js"; /* Load Player API*/
        ...
        manageVideoLayer: function (_nc, opt, recalled, internrecalled) {
            ...
            switch (newvideotype) {
				...
				*/
                    ...
                    if (
                        (_ISM && _nc.data("disablevideoonmobile") == 1) ||
                        _R.isIE(8)
                    )
                        _nc.find(tag).remove();
            ...
            if (
                ...
                if (_nc.find("iframe").length == 0)
                    _nc.find(".tp-videoposter").click(function () {
                        _R.playVideo(_nc, opt);
                        if (_ISM) {
                            if (_nc.data("disablevideoonmobile") == 1)
                                return false;
                            punchgs.TweenLite.to(
                                _nc.find(".tp-videoposter"),
                                0.3,
                                {
                                    autoAlpha: 0,
                                    force3D: "auto",
    ...
    function getStartSec(st) {
        return st == undefined
            ...
            : jQuery.isNumeric(st)
              ? st
              : st.split(":").length > 1
                ? parseInt(st.split(":")[0], 0) * 60 +
                  parseInt(st.split(":")[1], 0)
                : st;
    }
                            ...
                            onStateChange: function (event) {
                                ...
                                if (event.data == YT.PlayerState.PLAYING) {
                                    ...
                                    if (
                                        ...
                                        ((_nc.data("showcoveronpause") ==
                                            "on" &&
                                            _nc.find(".tp-videoposter").length >
                                                0) ||
                                            (_nc.data("bgvideo") === 1 &&
                                    ...
                                    if (event.data != -1 && event.data != 3) {
                                        ...
                                        if (
                                            opt.currentLayerVideoIsPlaying ==
                                                undefined ||
                                            opt.currentLayerVideoIsPlaying.attr(
                                                "id",
                                            ) == _nc.attr("id")
                                        )
                ...
                case "vimeo":
                    ...
                    f.on("loaded", function (data) {
                        ...
                        f.getVideoWidth().then(function (width) {
                            newas.width = width;
                            if (
                                newas.width !== undefined &&
                                newas.height !== undefined
                            ) {
                                _nc.data(
                                    "aspectratio",
                                    newas.width + ":" + newas.height,
                                );
                    ...
                    f.on("play", function (data) {
                        ...
                        if (!_nc.data("vimeoplaysinline")) {
                            if (
                                ...
                                f.setVolume(
                                    parseInt(_nc.data("volume"), 0) / 100 ||
                                        0.75,
                                );
                            _R.toggleState(_.videotoggledby);
                        }
    ...
    var htmlvideoevents = function (_nc, opt, startnow) {
        ...
        addEvent(video, "play", function () {
            ...
            vol =
                vol != undefined && vol != "mute" ? parseFloat(vol) / 100 : vol;
