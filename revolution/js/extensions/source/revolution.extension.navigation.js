...
(function ($) {
    ...
    jQuery.extend(true, _R, {
                    ...
                    bw.find(".tp-bullet").each(function (i) {
                        var b = jQuery(this),
                            ...
                            w =
                                b.outerWidth() +
                                parseInt(
                                    otbu.space === undefined ? 0 : otbu.space,
                                    0,
                                ),
                            h =
                                b.outerHeight() +
        ...
        createNavigation: function (container, opt) {
                    ...
                    if (_a.enable === true) {
                        ...
                        if (!_a.rtl) {
                            punchgs.TweenLite.set(
                                _a.left.j.find(".tp-arr-imgholder"),
                                {
                                    backgroundImage:
                                        "url(" + opt.thumbs[pi].src + ")",
                                },
                            );
                            punchgs.TweenLite.set(
                                _a.right.j.find(".tp-arr-imgholder"),
                                {
                                    backgroundImage:
                                        "url(" + opt.thumbs[ni].src + ")",
                                },
                            );
                        } else {
                            punchgs.TweenLite.set(
            ...
            if (opt.sliderType === "carousel")
                swipeAction(container, opt, true);
            if (
    ...
    var moveThumbsInPosition = function (container, opt) {
        var thumbs = container.hasClass("tp-thumbs")
                ? ".tp-thumbs"
                : ".tp-tabs",
        ...
        curpos =
            curpos < 0 - (els - ts) ? 0 - (els - ts) : curpos > 0 ? 0 : curpos;
    ...
    var rtt = function (f, tws, c, o, lis, wh) {
        var h = c.parent().find(".tp-" + wh + "s"),
            ...
            cw =
                o.width * f < o.min_width
                    ? o.min_width
                    : Math.round(o.width * f),
            ch = Math.round((cw / o.width) * o.height),
            iw =
                o.direction === "vertical"
                    ? cw
                    : cw * lis + o.space * (lis - 1),
            ih =
                o.direction === "vertical"
                    ? ch * lis + o.space * (lis - 1)
                    : ch,
            anm =
                o.direction === "vertical"
                    ? { width: cw + "px" }
        ...
        jQuery(document).keydown(function (e) {
            if (
                (opt.navigation.keyboard_direction == "horizontal" &&
                    e.keyCode == 39) ||
                (opt.navigation.keyboard_direction == "vertical" &&
                    e.keyCode == 40)
            ) {
        ...
        var notonbody = _ISM || _R.get_browser() === "Firefox",
            ...
            pagescroll =
                ...
                opt.navigation.tabs.direction === "vertical"
                    ...
                    : "vertical",
            swipe_wait_dir =
                opt.navigation.touch.swipe_direction || "horizontal";
        ...
        SwipeOn.swipetp({
            ...
            swipeStatus: function (
                ...
                if (
                    ...
                    if (_ISM && (direction === "up" || direction === "down"))
                        return;
                ...
                // SWIPE OVER THUMBS OR TABS
                    ...
                    var thumbs = opt.dragStartedOverThumbs
                            ? ".tp-thumbs"
                            : ".tp-tabs",
                        ...
                        thumbsiw = opt.dragStartedOverThumbs
                            ? ".tp-thumbs-inner-wrapper"
                            : ".tp-tabs-inner-wrapper",
                        thumb = opt.dragStartedOverThumbs
                            ? ".tp-thumb"
                            : ".tp-tab",
                    ...
                    var t = container.parent().find(thumbmask),
                        ...
                        tw =
                            tdir === "vertical"
                                ? t.find(thumb).first().outerHeight(true) +
                                  _o.space
                                : t.find(thumb).first().outerWidth(true) +
                                  _o.space,
                        newpos =
    ...
    var hdResets = function (o) {
        o.hide_delay = !jQuery.isNumeric(parseInt(o.hide_delay, 0))
            ? 0.2
            : o.hide_delay / 1000;
        o.hide_delay_mobile = !jQuery.isNumeric(
            parseInt(o.hide_delay_mobile, 0),
        )
            ? 0.2
    ...
    var addBullet = function (container, o, li, opt) {
        ...
        var b = container.find(".justaddedbullet"),
            ...
            w =
                b.outerWidth() +
                parseInt(o.space === undefined ? 0 : o.space, 0),
            h =
                b.outerHeight() +
                parseInt(o.space === undefined ? 0 : o.space, 0);
    ...
    var addThumb = function (container, o, li, what, opt) {
        ...
        o.visibleAmount =
            o.visibleAmount > opt.slideamount
                ? opt.slideamount
                : o.visibleAmount;
        ...
        if (container.parent().find(thumbs).length === 0) {
            ...
            // OUTTUER PADDING DEFAULTS
            (o.padding_top = parseInt(opt.carousel.padding_top || 0, 0)),
                (o.padding_bottom = parseInt(
                    opt.carousel.padding_bottom || 0,
                    0,
                ));
        ...
        var linkto = li.data("index"),
            ...
            maxw =
                o.direction === "horizontal"
                    ? o.width * o.visibleAmount +
                      o.space * (o.visibleAmount - 1)
                    : o.width,
            maxh =
                o.direction === "horizontal"
                    ? o.height
                    : o.height * o.visibleAmount +
                      o.space * (o.visibleAmount - 1),
            inst = o.tmp;
        jQuery.each(opt.thumbs[li.index()].params, function (i, obj) {
            inst = inst.replace(obj.from, obj.to);
