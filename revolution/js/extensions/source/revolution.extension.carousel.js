    ...
    jQuery.extend(true, _R, {
        ...
        organiseCarousel: function (opt, direction, setmaind, unli) {
            ...
            for (var i = 0; i < len; i++) {
                ...
                if (_.infinity === "on") {
                    pos =
                        pos > _.wrapwidth - _.inneroffset &&
                        direction == "right"
                            ? _.slide_offset -
                              (_.slides.length - i) * _.slide_width
                            : pos;
                    pos =
            ...
            if (_.slides)
                jQuery.each(_.slides, function (i, slide) {
                    ...
                    var d =
                            _.horizontal_align === "center"
                                ? (Math.abs(_.wrapwidth / 2) -
                                      (tr.left + _.slide_width / 2)) /
                                  _.slide_width
                    ...
                    if (_.fadeout === "on")
                        if (_.vary_fade === "on")
                            tr.autoAlpha =
                                1 -
                                Math.abs(
                                    (1 / Math.ceil(_.maxVisibleItems / ha)) * d,
                                );
                        else
                            switch (_.horizontal_align) {
                                case "center":
                                    tr.autoAlpha =
                                        Math.abs(d) <
                                        Math.ceil(_.maxVisibleItems / ha - 1)
                                            ? 1
                                            : 1 -
                                              (Math.abs(d) -
                        ...
                        tr.autoAlpha =
                            Math.abs(d) < Math.ceil(_.maxVisibleItems / ha)
                                ? 1
                                : 0;
                        ...
                        if (_.vary_scale === "on") {
                            tr.scale =
                                ...
                                Math.abs(
                                    (_.minScale /
                                        100 /
                                        Math.ceil(_.maxVisibleItems / ha)) *
                                        d,
                                );
                            var sx =
                                (_.slide_width - _.slide_width * tr.scale) *
                                Math.abs(d);
                        } else {
                            tr.scale =
                                d >= 1 || d <= -1
                            ...
                            var sx =
                                (_.slide_width -
                                    _.slide_width * (1 - _.minScale / 100)) *
                                Math.abs(d);
                        }
                    }
                    ...
                    // ROTATION FUNCTIONS
                    if (
                        _.maxRotation !== undefined &&
                        Math.abs(_.maxRotation) != 0
                    ) {
                        if (_.vary_rotation === "on") {
                            ...
                            tr.autoAlpha =
                                Math.abs(tr.rotationY) > 90 ? 0 : tr.autoAlpha;
                        } else {
                            tr.rotationY =
                                d >= 1 || d <= -1
                                    ? _.maxRotation
                                    : Math.abs(d) * _.maxRotation;
                        }
...
***************************************************/
    ...
    var setCarouselDefaults = function (opt) {
        ...
        _.wrapwidth =
            _.maxVisibleItems * _.slide_width +
            (_.maxVisibleItems - 1) * _.space;
        _.wrapwidth =
