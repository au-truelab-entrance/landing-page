	...
	*/
        ...
        if (opt.testanims == true) {
            opt.nexttesttransform =
                opt.nexttesttransform === undefined
                    ? 34
                    : opt.nexttesttransform + 1;
            opt.nexttesttransform =
        ...
        jQuery.each(
            ...
            function (i, b) {
                if (comingtransition == b + "horizontal")
                    comingtransition =
                        slidedirection != 1 ? b + "left" : b + "right";
                if (comingtransition == b + "vertical")
                    comingtransition =
                        slidedirection != 1 ? b + "up" : b + "down";
            },
        );
        ...
        if (comingtransition == "random-static") {
            comingtransition = Math.round(
                Math.random() * flatTransitions.length - 1,
            );
        ...
        function findTransition() {
            ...
            jQuery.each(transitionsArray, function (inde, trans) {
                if (
                    trans[0] == comingtransition ||
                    trans[8] == comingtransition
                ) {
                    nexttrans = trans[1];
                    specials = trans[2];
    ...
    var animateSlideIntern = function (
        ...
        opt.slots =
            opt.slots < 1
                ...
                : opt.slots;
        opt.slots =
            (nexttrans == 4 || nexttrans == 5 || nexttrans == 6) &&
            opt.slots < 3
                ? 3
                : opt.slots;
                ...
                subtl.add(
                    punchgs.TweenLite.fromTo(
                        ...
                        { left: 0, top: 0, opacity: 0, force3D: "auto" },
                        {
                            ...
                            width:
                                nextsh.find(".defaultimg").data("neww") + "px",
                            height:
                                nextsh.find(".defaultimg").data("newh") + "px",
                            opacity: 1,
                            ease: eo,
                            rotation: 0,
                        },
        ...
        if (
            ...
            mtl.add(
                punchgs.TweenLite.fromTo(actsh, masterspeed / 1000, fa, ta),
                0,
            );
            mtl.add(
                punchgs.TweenLite.fromTo(
            ...
            mtl.add(
                punchgs.TweenLite.fromTo(slot, masterspeed / 1000, fc, tc),
                0,
            );
            mtl.add(
                punchgs.TweenLite.fromTo(
                    ...
                    var _blur =
                            jQuery.inArray(specials, [9, 10]) >= 0
                                ...
                                : jQuery.inArray(specials, [11, 12]) >= 0
                                  ...
                                  : 0,
                        _gray =
                            jQuery.inArray(specials, [5, 6, 7, 8]) >= 0
                                ? 100
                                : 0,
                        _bright =
                            jQuery.inArray(specials, [7, 8]) >= 0 ? 300 : 0,
                        __ff =
                            "blur(" +
                            _blur +
                            "px) grayscale(" +
