        ...
        startKenBurn: function (l, opt, prgs) {
            ...
            var getKBSides = function (w, h, f, cw, ch, ho, vo) {
                ...
                kcalcL = function (cw, ch, d) {
                    ...
                    ofs[0] =
                        ofs[0] > 0 ? 0 : iws + ofs[0] < cw ? cw - iws : ofs[0];
                    ofe[0] =
                        ofe[0] > 0 ? 0 : iwe + ofe[0] < cw ? cw - iwe : ofe[0];

                    ofs[1] =
                        ofs[1] > 0 ? 0 : ihs + ofs[1] < ch ? ch - ihs : ofs[1];
                    ofe[1] =
                        ofe[1] > 0 ? 0 : ihe + ofe[1] < ch ? ch - ihe : ofe[1];
